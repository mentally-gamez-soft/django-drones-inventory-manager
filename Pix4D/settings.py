"""
Django settings for Pix4D project.
...
SECRET_KEY = os.environ.get('PIX4D_SECRET_KEY')
...
INSTALLED_APPS = [
    ...
    'support_team.apps.SupportTeamConfig',
    'crispy_forms',
]
...
WSGI_APPLICATION = 'Pix4D.wsgi.application'
